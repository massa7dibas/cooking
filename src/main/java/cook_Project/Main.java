...
import static cook_Project.EmailService.sendNotification;
               ...
               for(int i=0;i<3;i++){
                ...
                case "2":
                    ...
                    if (Application.isUserLoggedIn()) {
                        System.out.println("Logged in as " + Application.main_User.getRole());
                        String roleLoggedIn = Application.main_User.getRole();
                        switch (roleLoggedIn) {
                            case "Admin":
